...
class AppColors {
  ...
  // Random
  static const scaffold = Color(0XFFF6FAFF);
  ...
  static const highlightDark = Color(0XFFD6E4F6);
  static const inactive = Color(0XFFD9D9D9);
  static const containerBorder = Color(0XFFEDEDED);
  static const divider = Color(0XFFF2F2F2);
  static const remove = Color(0XFFDC1D1D);
  static const danger = Color(0XFFBB1D1D);
