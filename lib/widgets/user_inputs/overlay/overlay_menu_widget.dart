...
import 'overlay_button_widget.dart';
import 'overlay_decoration_widget.dart';
...
class OverlayMenuWidget<T> extends StatefulWidget {
  ...
  @override
  State<OverlayMenuWidget<T>> createState() => _OverlayMenuWidgetState<T>();
}

class _OverlayMenuWidgetState<T> extends State<OverlayMenuWidget<T>> {
  ...
  /// Each item is rendered as an [OverlayButtonWidget].
...
/// Represents a single item in the [OverlayMenuWidget].
