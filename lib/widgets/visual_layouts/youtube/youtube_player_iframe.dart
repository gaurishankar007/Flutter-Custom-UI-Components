...
import 'media_controller/youtube_video_controller.dart';
...
class _YoutubePlayerIframeState extends State<YoutubePlayerIframe> {
  ...
  Widget build(BuildContext context) {
    if (_videoId.isEmpty) return ErrorIcon(width: widget.width);

    Widget videoPlayerWidget = YoutubePlayer(
      controller: _controller,
      aspectRatio: widget.aspectRatio,
    );
    Widget controllerWidget = YoutubeVideoController(
      controller: _controller,
