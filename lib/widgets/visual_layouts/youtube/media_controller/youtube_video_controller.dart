...
class YoutubeVideoController extends StatefulWidget {
  ...
  @override
  State<YoutubeVideoController> createState() => _YoutubeVideoControllerState();
}

class _YoutubeVideoControllerState extends State<YoutubeVideoController> {
  ...
  Widget build(BuildContext context) {
    Widget playSeekButtonWidget = MediaPlaySeekButton(
